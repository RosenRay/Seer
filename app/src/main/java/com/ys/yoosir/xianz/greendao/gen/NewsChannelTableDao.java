...
*/
public class NewsChannelTableDao extends AbstractDao<NewsChannelTable, Long> {
    ...
    @Override
    protected final Long updateKeyAfterInsert(NewsChannelTable entity, long rowId) {
        entity.set_id(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(NewsChannelTable entity) {
        if(entity != null) {
