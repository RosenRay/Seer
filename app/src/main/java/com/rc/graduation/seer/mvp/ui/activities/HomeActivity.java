...
import com.rc.graduation.seer.robot.RobotActivity;
import com.rc.graduation.seer.utils.SharedPreferencesUtil;
import com.rc.graduation.seer.widget.video.VideoPlayView;
...
//    private static final String CHILD_FRAGMENT_TAG_VIDEO = "child_video" ;
    private static final String CHILD_FRAGMENT_TAG_ROBOT = "child_robot" ;
    private static final String CHILD_FRAGMENT_TAG_NEWS2 = "child_news2" ;
    private static final String CHILD_FRAGMENT_TYPE = "CHILD_FRAGMENT_TYPE";

    private NewsFragment mNewsFragment;
    private VideoFragment mVideoFragment;
    private PhotoFragment mPhotoFragment;
    private WeixinFragment mNews2Fragment;
//    private RobotFragment mRobotFragment;
    ...
    private String  childFragmentType; // 1.news ; 2.photo ; 3.video ; 4.robot
    ...
    public void initVariables() {
        ...
        mNews2Fragment = new WeixinFragment();
...
//        mDrawerLayout.setDrawerListener(toggle);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_news) {
            ...
            if(!CHILD_FRAGMENT_TAG_NEWS2.equals(childFragmentType)) {
                setChildFragment(CHILD_FRAGMENT_TAG_NEWS2);
            }
        } else if (id == R.id.nav_robot) {
            if (! CHILD_FRAGMENT_TAG_ROBOT.equals(childFragmentType)) {
                setChildFragment(CHILD_FRAGMENT_TAG_NEWS);
                startActivity(new Intent(HomeActivity.this, RobotActivity.class));
            }
        } else {
