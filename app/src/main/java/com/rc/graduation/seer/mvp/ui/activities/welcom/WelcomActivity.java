...
import com.rc.graduation.seer.mvp.ui.activities.SplashActivity;
...
public class WelcomActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		boolean isFrist = getSharedPreferences("myshared", Context.MODE_PRIVATE).getBoolean("isFrist", true);
		if (isFrist) {
			//首次安装，去引导页
			getSharedPreferences("myshared", Context.MODE_PRIVATE).edit().putBoolean("isFrist", false).commit();
